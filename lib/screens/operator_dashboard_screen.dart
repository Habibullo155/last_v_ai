                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (_active.isNotEmpty) ...[
                                      Text(
                                        l10n.operatorDashboardMyActiveSection(
                                          _active.length,
                                        ),
                                        style: TextStyle(
                                    ...
                                    Text(
                                      l10n.operatorDashboardPendingSection(
                                        _pending.length,
                                      ),
                                      style: TextStyle(
                                        color: context.onSurfaceFaded(0.4),
                                    ...
                                    if (_pending.isEmpty)
                                      Padding(
                                        ...
                                        child: Center(
                                          child: Text(
                                            l10n.operatorDashboardNoOneWaiting,
                                            style: TextStyle(
                ...
                children: [
                  ...
                  Text(
                    session.reason?.isNotEmpty == true
                        ? session.reason!
                        : l10n.operatorDashboardNoDescription,
                    maxLines: 2,
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: isClaiming
                      ...
                      : Text(
                          l10n.operatorDashboardAcceptButton,
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.w600,
                          ),
