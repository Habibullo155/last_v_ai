                        ...
                        child: SingleChildScrollView(
                          child: Text(
                            _controller.text.isEmpty
                                ? l10n.freewritingEmptyPlaceholder
                                : _controller.text,
                            style: TextStyle(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: FilledButton(
                              ...
                              onPressed: () => Navigator.of(context).pop(),
                              child: Text(l10n.freewritingKeepAndCloseButton),
                            ),
                          ),
                        ],
                      ),
