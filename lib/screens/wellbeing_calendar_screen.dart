...
class WellbeingCalendarScreen extends StatefulWidget {
  ...
  @override
  State<WellbeingCalendarScreen> createState() =>
      _WellbeingCalendarScreenState();
}
...
class _WellbeingCalendarScreenState extends State<WellbeingCalendarScreen> {
  ...
  Future<void> _load() async {
    ...
    if (token != null) {
      try {
        customResults = await CustomTestsService().myResults(
    ...
    for (final c in who5) {
      add(
        _DayEntry(
          date: c.date,
          label: l10n.wellbeingCalendarWho5Label,
    ...
    for (final r in customResults) {
      ...
      add(
        _DayEntry(
          ...
          label: r.testTitle,
          score:
              r.resultLabel ?? l10n.wellbeingCalendarScoreSuffix(r.totalScore),
  ...
  Widget build(BuildContext context) {
    ...
    final selectedEntries = _selectedDay != null
        ? _entriesByDay[_dayKey(_selectedDay!)] ?? []
        : <_DayEntry>[];
                ...
                child: Row(
                  children: [
                    ...
                    TextButton.icon(
                      ...
                      label: Text(
                        l10n.wellbeingCalendarTakeTestButton,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                if (selectedEntries.isNotEmpty) ...[
                                  ...
                                  Center(
                                    child: Text(
                                      l10n.wellbeingCalendarEmptyState,
        ...
        children: [
          ...
          GridView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final isSelected =
                  _selectedDay != null && _dayKey(_selectedDay!) == key;
