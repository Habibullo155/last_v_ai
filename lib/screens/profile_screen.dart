...
class _ProfileScreenState extends State<ProfileScreen> {
      ...
      children: [
        ...
        _sectionCard(l10n.profileSectionPersonal, [
          ...
          _row(
            ...
            user.emergencyContact?.isNotEmpty == true
        ...
        _sectionCard(l10n.profileSectionAccount, [
          _row(
            ...
            user.email,
            onTap: () =>
                _showEmailChangeDialog(context, widget.authStore, user),
          ),
          _row(
            l10n.profileRole,
            user.isAdmin ? l10n.profileRoleAdmin : l10n.profileRoleUser,
          ),
          _row(
            l10n.profileAccountCreated,
            DateFormat.yMMMd(
  ...
  Future<void> _showEmailChangeDialog(
    BuildContext context,
    AuthStore authStore,
    AppUser user,
  ) async {
    await showDialog(
      context: context,
      builder: (context) =>
          _EmailChangeDialog(authStore: authStore, currentEmail: user.email),
    );
  }
  ...
  Future<void> _editBirthDateInline(
    BuildContext context,
    AuthStore authStore,
    AppUser user,
  ) async {
  ...
  Widget _row(String label, String value, {VoidCallback? onTap}) {
    final row = Row(
      ...
      children: [
        Text(
          label,
          style: TextStyle(color: context.onSurfaceFaded(0.55), fontSize: 13.5),
        ),
        Row(
          mainAxisSize: MainAxisSize.min,
          children: [
...
class _PasswordChangeDialogState extends State<_PasswordChangeDialog> {
  ...
  Future<void> _save() async {
    ...
    if (newPassword.length < 8) {
      setState(() => _error = l10n.profilePasswordTooShort);
      return;
    }
    if (newPassword != confirm) {
      setState(() => _error = l10n.profilePasswordsDontMatch);
      return;
    }
    ...
    final error = await widget.authStore.changePassword(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  labelText: l10n.profileRepeatNewPasswordLabel,
                  labelStyle: TextStyle(color: context.onSurfaceFaded(0.5)),
                ),
              ),
              if (_error != null) ...[
...
class _EmailChangeDialogState extends State<_EmailChangeDialog> {
  ...
  Future<void> _requestChange() async {
    ...
    final error = await widget.authStore.requestEmailChange(
      newEmail: newEmail,
        ...
        child: ConstrainedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text(
                l10n.profileCurrentEmailLabel(widget.currentEmail),
                style: TextStyle(
                  color: context.onSurfaceFaded(0.5),
                  fontSize: 12,
                ),
              ...
              if (_stage == _EmailChangeStage.enterNewEmail) ...[
                ...
                Text(
                  l10n.profileCodeSentToEmail(_newEmailController.text.trim()),
                  style: TextStyle(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: l10n.profileCodeFromEmailLabel,
                    labelStyle: TextStyle(color: context.onSurfaceFaded(0.5)),
                  ),
                ),
              ],
              ...
              Row(
                ...
                children: [
                  ...
                  FilledButton(
                    ...
                    onPressed: _isSaving
                        ? null
                        : (_stage == _EmailChangeStage.enterNewEmail
                              ? _requestChange
                              : _confirmChange),
                    child: _isSaving
                        ? const SizedBox(
                        ...
                        : Text(
                            _stage == _EmailChangeStage.enterNewEmail
                                ? l10n.profileSendCodeButton
                                : l10n.profileConfirmButton,
                          ),
                  ),
                ],
              ),
