...
class _LeavesOnStreamScreenState extends State<LeavesOnStreamScreen>
            ...
            child: GlassPanel(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: l10n.leavesOnStreamHint,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: const LinearGradient(
                    colors: [Color(0xFF00B4D8), Color(0xFF00E6A0)],
                  ),
                ),
                child: Text(
...
class _StreamPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final opacity =
        (progress < 0.08
                ? progress / 0.08
                : (progress > 0.92 ? (1 - progress) / 0.08 : 1.0))
            .clamp(0.0, 1.0);
