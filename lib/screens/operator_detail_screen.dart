...
class _OperatorDetailScreenState extends State<OperatorDetailScreen> {
        ...
        child: GlassPanel(
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  l10n.operatorIssueWarningTitle,
                  style: TextStyle(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: l10n.operatorWarningReasonHint,
                ...
                Row(
                  ...
                  children: [
                    ...
                    FilledButton(
                      ...
                      child: Text(l10n.operatorIssueButton),
                    ),
                  ],
                ),
              ],
  ...
  Future<void> _revokeAccess() async {
    ...
    final confirmed = await _confirm(
      title: l10n.operatorRevokeAccessTitle,
      body: l10n.operatorRevokeAccessBody(widget.operator.email),
      confirmLabel: l10n.operatorRevokeAccessConfirm,
    );
  ...
  Future<void> _deleteAccount() async {
    final l10n = AppLocalizations.of(context)!;
    final confirmed = await _confirm(
      title: l10n.operatorDeleteAccountTitle,
      body: l10n.operatorDeleteAccountBody(widget.operator.email),
      confirmLabel: l10n.operatorDeleteAccountConfirm,
    );
    if (confirmed != true) return;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (_warnings.isNotEmpty) ...[
                                      ...
                                      Text(
                                        l10n.operatorWarningsSectionCount(
                                          _warnings.length,
                                        ),
                                        style: TextStyle(
                                    ...
                                    const SizedBox(height: 20),
                                    Text(
                                      l10n.operatorSessionsSectionCount(
                                        _sessions.length,
                                      ),
                                      style: TextStyle(
                                        color: context.onSurfaceFaded(0.4),
                                    ...
                                    if (_sessions.isEmpty)
                                      Padding(
                                        ...
                                        child: Center(
                                          child: Text(
                                            l10n.operatorNoSessionsYet,
                                            style: TextStyle(
                                              color: context.onSurfaceFaded(
                                                0.4,
                                              ),
                                            ),
                                          ),
      ...
      children: [
        Expanded(
          child: OutlinedButton.icon(
            ...
            label: Text(l10n.operatorWarningButtonShort),
          ),
        ),
        const SizedBox(width: 8),
        Expanded(
          child: OutlinedButton.icon(
            ...
            label: Text(l10n.operatorRevokeAccessButtonShort),
          ),
        ),
        const SizedBox(width: 8),
        IconButton(
          ...
          tooltip: l10n.operatorDeleteAccountTooltip,
        ),
      ],
    );
  }
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          session.userEmail ?? l10n.operatorUnknownUser,
                          style: TextStyle(
                            color: context.onSurface,
                            fontSize: 13,
                        ...
                        if (session.ratingComment != null &&
                            session.ratingComment!.isNotEmpty) ...[
                          const SizedBox(height: 4),
                          Text(
                            l10n.operatorQuotedComment(session.ratingComment!),
                            maxLines: 2,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              color: context.onSurfaceFaded(0.5),
