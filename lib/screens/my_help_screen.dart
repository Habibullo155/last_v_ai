                              ...
                              GlassPanel(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      l10n.myHelpCallPersonDescription,
                                      style: TextStyle(
                                    ...
                                    TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText: l10n.myHelpDescribeHint,
                                        hintStyle: TextStyle(
  ...
  Widget _buildSessionTile(HelpSession session) {
    ...
    final (label, color) = switch (session.status) {
      HelpSessionStatus.pending => (
        l10n.myHelpStatusPending,
        const Color(0xFFFFD166),
      ),
      HelpSessionStatus.active => (
        l10n.myHelpStatusActive,
        const Color(0xFF00E6A0),
      ),
      HelpSessionStatus.closed => (l10n.myHelpStatusClosed, Colors.white38),
    };
    return Padding(
