...
class _Phq9ScreenState extends State<Phq9Screen> {
  ...
  Widget _buildTest() {
    final riskAnswered = _currentAnswers[phq9RiskItemIndex] != null && _currentAnswers[phq9RiskItemIndex]! > 0;
    return ListView(
      shrinkWrap: true,
      ...
      children: [
        ...
        const SizedBox(height: 16),
        for (var i = 0; i < phq9Questions.length; i++) ...[
          _buildQuestion(i),
          if (i == phq9RiskItemIndex && riskAnswered) ...[
            const SizedBox(height: 10),
