...
// что в models/phq9_checkin.dart и подобных)
List<_GroundingStep> _steps(AppLocalizations l10n) => [
  _GroundingStep(5, l10n.groundingSightSense, l10n.groundingSightPrompt),
  _GroundingStep(4, l10n.groundingTouchSense, l10n.groundingTouchPrompt),
  _GroundingStep(3, l10n.groundingHearingSense, l10n.groundingHearingPrompt),
  _GroundingStep(2, l10n.groundingSmellSense, l10n.groundingSmellPrompt),
  _GroundingStep(1, l10n.groundingTasteSense, l10n.groundingTastePrompt),
];
                ...
                child: Center(
                  child: ConstrainedBox(
                    ...
                    child: Padding(
                      ...
                      child: _stepIndex == -1
                          ? _buildDone()
                          : _buildStep(_steps(l10n)[_stepIndex]),
                    ),
                  ),
                ),
              ),
  ...
  Widget _buildStep(_GroundingStep step) {
    ...
    return Column(
      ...
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: List.generate(_steps(l10n).length, (i) {
        ...
        Material(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              child: Text(
                _stepIndex < _steps(l10n).length - 1
                    ? l10n.groundingNextButton
                    : l10n.commonDone,
    ...
    return Column(
      ...
      children: [
        ...
        GlassPanel(
          ...
          child: Text(
            l10n.groundingIfAnxietyPersists,
            textAlign: TextAlign.center,
            style: TextStyle(
              color: context.onSurfaceFaded(0.45),
              fontSize: 12,
        ...
        TextButton(
          onPressed: _restart,
          child: Text(l10n.groundingStartOverButton),
        ),
      ],
    );
  }
