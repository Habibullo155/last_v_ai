...
class CustomTestTakingScreen extends StatefulWidget {
  ...
  const CustomTestTakingScreen({
    super.key,
    required this.authStore,
    required this.testId,
    this.onDiscussWithAi,
  });
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        _test?.title ?? l10n.customTestDefaultTitle,
                        style: TextStyle(
                          color: context.onSurface,
                          fontSize: 17,
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: switch (_stage) {
                        ...
                        _Stage.error => Text(
                          _error ?? l10n.customTestLoadFailed,
    ...
    return GlassPanel(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            l10n.customTestQuestionCount(test.questions.length),
  ...
  Widget _buildQuestion() {
    ...
    return Column(
      ...
      children: [
            ...
            (i) => Expanded(
              child: Container(
                margin: EdgeInsets.only(
                  right: i < test.questions.length - 1 ? 4 : 0,
                ),
                height: 4,
                decoration: BoxDecoration(
        ...
        Text(
          l10n.customTestQuestionProgress(
            _currentQuestion + 1,
            test.questions.length,
          ),
            ...
            SizedBox(
              ...
              child: Material(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular(14),
                  onTap: () async {
                    final text = l10n.customTestDiscussPrompt(
                      _test!.title,
                      result.totalScore,
                      result.resultLabel != null
                          ? l10n.customTestResultNote(result.resultLabel!)
                          : '',
                    );
