...
class _SafeContainmentScreenState extends State<SafeContainmentScreen>
                      ...
                      child: switch (_stage) {
                        ...
                        _Stage.animating => SizedBox(
                          ...
                          child: AnimatedBuilder(
                            ...
                            builder: (context, _) => _SafeAnimation(
      ...
      children: [
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            hintText: l10n.safeContainmentHint,
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  colors: [Color(0xFF5C7A99), Color(0xFF8FA8BF)],
                ),
              ),
              child: Text(
                l10n.safeContainmentPutAwayButton,
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    ...
                    gradient: RadialGradient(
                      colors: [Color(0xFF6B6B94), Color(0xFF3A3A5C)],
                    ),
                  ),
                ),
              ),
