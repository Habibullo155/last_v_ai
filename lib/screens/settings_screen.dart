      ...
      if (mounted) {
        setState(() {
          ...
          if (granted) {
            ...
            _reminderError = AppLocalizations.of(
              context,
                              ...
                              return GlassPanel(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      l10n.settingsBackgroundColorLabel,
                                      style: TextStyle(
                                        color: context.onSurface,
                                      ),
                                    ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            l10n.settingsPerformanceModeLabel,
                                            style: TextStyle(
                                              color: context.onSurface,
                                            ),
                                          ),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            l10n.settingsVibrationOnMessage,
                                            style: TextStyle(
                                              color: context.onSurface,
                                            ),
                                          ),
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            l10n.settingsVoiceButtonsInChat,
                                            style: TextStyle(
                                              color: context.onSurface,
                                              fontSize: 13.5,
                                            ),
                                      ...
                                      child: Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Expanded(
                                              child: Text(
                                                l10n.settingsReminderTimeLabel,
                                                style: TextStyle(
                                                  color: context.onSurfaceFaded(
                                                    0.75,
                                                  ),
